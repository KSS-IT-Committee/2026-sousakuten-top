...
います。物理室・理科室にて、各班の集大成をぜひご覧ください。",
  ...
  { name: "生物研究会", title: "生物研究会", floor: 3, location: "生物室" },
  {
    name: "料理研究会",
    title: "おやつにしませんか？",
    floor: 3,
...
のおやつはいかがですか？皆様のお越しをお待ちしております。",
  },
  {
    ...
    location: "資料コーナー",
    description:
      "創作展で部誌を販売します！今年は部員が増えたため、なんと2種類を発行！どちらも力作です。ぜひ片方だけでも手にとってください！落書きスペースも用意するのでフラットお立ち寄りください!",
  },
  {
    name: "パソコン研究会 ",
    title: '"Hello World"展 ',
