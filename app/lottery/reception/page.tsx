    ...
    <div className={styles.main}>
      <header className={styles.header}>
        ...
        <p className={styles.lead}>
          自分のクラスの公演では、当選者が受付に来たらその行をタップして来場を記録してください。もう一度タップすると取り消せます。記録は裏で保存されるので、保存を待たずに次の人をタップできます。ほかのクラスの公演は閲覧のみです（IT委員・創作展委員はすべてのクラスの公演を記録できます）。受付締切（開演10分後）を過ぎると、その公演の記録は変更できなくなります。
        </p>
      </header>
