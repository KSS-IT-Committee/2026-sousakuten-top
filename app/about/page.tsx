  ...
  return (
    <article className={styles.main}>
      ...
      <Section title="投票・大賞について">
        ...
        <ul>
          <li>立志部門 ：1位（立志大賞）・2位・3位</li>
          <li>開拓部門 ：1位（開拓大賞）・2位・3位</li>
          <li>創作部門 ：1位（創作大賞）・2位・3位</li>
          <li>光庭パネル部門：1位・2位・3位</li>
          <li>外装・立志部門：1位・2位・3位</li>
          <li>外装・開拓部門：1位・2位・3位</li>
          <li>外装・創作部門：1位・2位・3位</li>
        </ul>
