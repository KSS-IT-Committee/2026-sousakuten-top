...
export const metadata: Metadata = pageMetadata({
  title: "機能のリクエスト",
  description: "創作展2026 公式サイトへの新機能・修正のリクエスト方法。",
  path: "/requests",
});
    ...
    <div className={styles.main}>
      ...
      <p className={styles.description}>
        <Link
          ...
          href={
            "https://github.com/KSS-IT-Committee/2026-sousakuten-top/issues/new"
          }
        >
          このページのリポジトリ
        </Link>
      ...
      <p className={styles.description}>
        ...
        宛にメールをお送りください。その際、どのページに関する提案か（このページであれば「創作展トップページ」）を本文に記載してください。
      </p>
