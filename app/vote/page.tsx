    ...
    <section className={styles.main}>
      ...
      <Section title="立志部門（1,2 年生）">
        <p>
          ...
          <br />
          また、教室の混雑緩和のため、１年生の分を会議室横、２年生の分を２Ｂ前の階段下にそれ
          ぞれ感想の記入場所を用意しております。是非そちらもご利用下さい。
        </p>
      </Section>
      <Section title="開拓部門（3,4 年生）・創作部門（5,6 年生）">
        <p>
          投票用紙は各教室で入場時にお配りします。そのクラスの劇を見た方のみ、投票することができます。劇を見
          終わったらその場で評価を記入していただき、教室退場時に各教室で回収します。
        </p>
      </Section>
      <Section title=" 外装部門・光庭パネル部門">
        ...
        <p>
          光庭（校舎中央吹き抜け）の宣伝パネルと外装（教室前・階段の装飾）について立志部門・開拓部門・創作
          部門の各部門の良いと思った順に 3
          つ、外装・光庭パネルでそれぞれ記入をお願いします。
          <br />
          投票用紙は投票箱に入れるか、黒に桃色の柄が入ったポロシャツを着た運営スタッフにお渡し下さい。投票
          箱は各階 1 か所、アリーナ 1 か所、光庭 2
          か所に設置しております（時間帯によっては追加）。
        </p>
      </Section>
