  ...
  return (
    <section className={styles.main}>
      ...
      <Section title=" 外装部門・光庭パネル部門">
        ...
        <p>
          光庭（校舎中央吹き抜け）の宣伝パネルと外装（教室前・階段の装飾）について立志部門・開拓部門・創作部門の各部門の良いと思った順に
          3つ、外装・光庭パネルでそれぞれ記入をお願いします。
          <br />
          投票用紙は投票箱に入れるか、黒に桃色の柄が入ったポロシャツを着た運営スタッフにお渡し下さい。投票箱は各階
          1 か所、アリーナ 1 か所、光庭
          2か所に設置しております（時間帯によっては追加）。
        </p>
      </Section>
